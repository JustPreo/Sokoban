...
public class Usuario implements Serializable {
    ...
    public long getTiempoPromedioNivel() {
        if (partidasCompletadas == 0) return 0;
    ...
    public ConfiguracionUsuario getPreferencias() { return preferencias; }
    ...
    public List<String> getListaAmigos() { return new ArrayList<>(listaAmigos); }
    public List<String> getListaRivales() { return new ArrayList<>(listaRivales); }
