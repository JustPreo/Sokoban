...
public class ConfiguracionUsuario implements Serializable {
    ...
    public Map<String, Integer> getControles() {
        return new HashMap<>(controles);
    }

    public void setControles(Map<String, Integer> nuevos) {
        this.controles.clear();
        this.controles.putAll(nuevos);
    }
    ...
    public boolean isAnimacionesActivadas() {
        return animacionesActivadas;
    }
    ...
    public boolean isEfectosParticulas() {
        return efectosParticulas;
    }
    ...
    public boolean isConfirmarMovimientos() {
        return confirmarMovimientos;
    }
    ...
    public boolean isModoDesafio() {
        return modoDesafio;
    }

    public void setModoDesafio(boolean modoDesafio) {
    ...
    public boolean isInvertirEjes() {
        return invertirEjes;
    }

    public void setInvertirEjes(boolean invertirEjes) {
        this.invertirEjes = invertirEjes;
    }
}
